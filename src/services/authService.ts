...
export class AuthService {
  ...
  static async getMe(): Promise<UserStatusResponse> {
    const response = await apiClient.get<UserStatusResponse>("/auth/me");
    return response.data;
  }
  ...
  static async registerClienteWithGoogle(
    ...
    const response = await apiClient.post<AuthResponse>(
      "/auth/google/register/cliente",
      data
    );
    return response.data;
  }

  static async registerGuiaWithGoogle(
    data: RegisterGuiaWithGoogleData
  ): Promise<AuthResponse> {
    const response = await apiClient.post<AuthResponse>(
      "/auth/google/register/guia",
      data
    );
    return response.data;
  }
