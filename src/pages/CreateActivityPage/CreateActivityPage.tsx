...
const inputStyle =
	"w-full px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-opacity-50";
							...
							<div>
								...
								<div className="mt-1 flex justify-center items-center flex-col px-6 py-10 border-2 border-dashed border-gray-300 rounded-md text-center hover:border-gray-400 transition-colors cursor-pointer">
									...
									<p className="text-sm text-gray-500 mt-2">
										Arraste e solte ou{" "}
										<span className="font-semibold" style={{ color: "var(--verde-oliva)" }}>
											clique para enviar
										</span>
									</p>
