        ...
        <div className="form-card w-full bg-white p-8 rounded-lg shadow-xl">
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="col-span-1 flex flex-col gap-6">
              <div>
                <label htmlFor="title" className="form-label">Título da Atividade</label>
                <input type="text" id="title" className="form-input" placeholder="Ex: Travessia da Serra Fina" />
              </div>
              
              <div>
                <label htmlFor="description" className="form-label">Descrição Detalhada</label>
                <textarea id="description" rows={5} className="form-input" placeholder="Conte sobre o roteiro, o que está incluso, etc."></textarea>
              </div>

              <div>
                <label htmlFor="location" className="form-label">Localização (Cidade/Estado)</label>
                <input type="text" id="location" className="form-input" placeholder="Ex: Passa Quatro, MG" />
              </div>

               <div>
                <label htmlFor="difficulty" className="form-label">Nível de Dificuldade</label>
            ...
            <div className="col-span-1 flex flex-col gap-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                 ...
                 <div>
                    <label htmlFor="maxParticipants" className="form-label">Vagas</label>
                    <input type="number" id="maxParticipants" className="form-input" placeholder="Ex: 10" />
                 </div>
              </div>
                
              <div>
                <label htmlFor="price" className="form-label">Preço por Pessoa (R$)</label>
              ...
              <div>
                ...
                <div className="image-upload-zone mt-1 flex justify-center items-center flex-col px-6 pt-5 pb-6 border-2 border-dashed rounded-md">
                    ...
                    <p className="text-sm text-gray-500 mt-2">Arraste e solte ou <span className="text-blue-600">clique para enviar</span></p>
            ...
            <div className="md:col-span-2 mt-4">
                <button type="submit" className="form-submit-button w-full text-white font-bold py-3 px-4 rounded-lg shadow-md transition-transform duration-300 hover:scale-105">
                    Publicar Atividade
                </button>
            </div>
          </form>
