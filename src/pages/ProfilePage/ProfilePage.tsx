				...
				<section className="w-full mt-8">
					<div className="border-b border-gray-200 flex justify-center md:justify-start">
						<button
							...
							className={`px-4 py-2 font-semibold border-b-2 transition-colors ${activeTab === "atividades" ? "border-verde-oliva text-verde-oliva" : "border-transparent text-gray-500 hover:text-verde-oliva"}`}
							style={{
								color: activeTab === "atividades" ? "var(--verde-oliva)" : "",
								borderColor: activeTab === "atividades" ? "var(--verde-oliva)" : "",
							}}
						>
						...
						<button
							...
							className={`px-4 py-2 font-semibold border-b-2 transition-colors ${activeTab === "avaliacoes" ? "border-verde-oliva text-verde-oliva" : "border-transparent text-gray-500 hover:text-verde-oliva"}`}
							style={{
								color: activeTab === "avaliacoes" ? "var(--verde-oliva)" : "",
								borderColor: activeTab === "avaliacoes" ? "var(--verde-oliva)" : "",
							}}
						>
							Avaliações
						</button>
						<button
							...
							className={`px-4 py-2 font-semibold border-b-2 transition-colors ${activeTab === "configuracoes" ? "border-verde-oliva text-verde-oliva" : "border-transparent text-gray-500 hover:text-verde-oliva"}`}
							style={{
								color: activeTab === "configuracoes" ? "var(--verde-oliva)" : "",
								borderColor: activeTab === "configuracoes" ? "var(--verde-oliva)" : "",
							}}
						>
							Configurações
						</button>
				...
				<section className="w-full mt-6">
						...
						<div>
							{isGuia && (
								<Link to="/criar-passeio">
									<button
										className="w-full md:w-auto text-white font-bold py-3 px-6 rounded-lg shadow-md transition-transform duration-300 hover:scale-105 flex items-center justify-center gap-2 mb-6"
										style={{ backgroundColor: "var(--verde-vibrante)" }}
									>
										<PlusCircle size={20} />
					...
					{activeTab === "avaliacoes" && (
						<div className="text-center p-10 bg-white rounded-lg shadow-md border border-[rgba(137,143,41,0.1)]">
							...
							<p className="text-gray-600 mt-2">
								Aqui serão exibidas as avaliações {isGuia ? "recebidas" : "feitas por você"}.
							</p>
						</div>
					)}
					{activeTab === "configuracoes" && (
						<div className="text-center p-10 bg-white rounded-lg shadow-md border border-[rgba(137,143,41,0.1)]">
							...
							<p className="text-gray-600 mt-2">
								Aqui você poderá alterar seus dados, senha e preferências.
							</p>
						</div>
					)}
				</section>
