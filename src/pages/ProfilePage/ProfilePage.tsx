...
const mockActivities = [
	{
		id: 1,
		title: "Travessia do Vale do Pati",
		date: "25/08/2025",
						...
						<div className="flex items-center justify-center md:justify-start gap-3">
							...
							{mockUser.isPaid && (
								<div
									...
									title={isGuia ? "Perfil Impulsionado" : "Usuário Prioritário"}
								>
						...
						<div>
							...
							<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
								{mockActivities.map((activity) => (
									<div
										key={activity.id}
										className="activity-card bg-white rounded-lg shadow-md overflow-hidden"
									>
										<img
											src={activity.image}
											alt={activity.title}
										...
										<div className="p-4">
											...
											{isGuia && (
												<div className="flex gap-2 mt-4">
													<button className="flex-1 text-sm font-semibold py-2 px-3 rounded-md bg-gray-200 hover:bg-gray-300">
														Editar
													</button>
													<button className="flex-1 text-sm font-semibold py-2 px-3 rounded-md bg-gray-200 hover:bg-gray-300">
														Ver inscritos
