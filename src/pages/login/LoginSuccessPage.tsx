	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-verde-oliva to-verde-escuro flex items-center justify-center p-4">
			<div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full text-center">
				...
				<h1 className="text-2xl font-bold text-verde-oliva mb-4">Login realizado com sucesso!</h1>

				<p className="text-gray-600 mb-6">Você será redirecionado automaticamente...</p>
