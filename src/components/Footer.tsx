    ...
    <footer className="w-full bg-white" style={{ borderTop: "1px solid rgba(137, 143, 41, 0.2)" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <nav className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm font-medium" style={{ color: 'var(--verde-oliva)' }}>
        ...
        <div className="text-center text-xs text-gray-400 mt-8 pt-6" style={{ borderTop: '1px solid rgba(137, 143, 41, 0.1)' }}>
          © {new Date().getFullYear()} ExploraMeet. Todos os direitos reservados. Jaboatão dos Guararapes, PE - Brasil.
        </div>
      </div>
    </footer>
  );
